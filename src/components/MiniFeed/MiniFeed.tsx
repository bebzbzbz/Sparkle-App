        ...
        return (  
            <article className="mb-20">
                <div className="flex gap-5 justify-center mb-5 h-5">
                    ...
                    <div onClick={() => setTimelineFeed(false)}>
                        {!timelineFeed 
                    ...
                    <div onClick={() => setTimelineFeed(true)}>
                        {timelineFeed 
                        ...
                        </svg> : <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="0.5" y="0.5" width="12" height="2.25" rx="1.125" stroke="currentColor"/><rect x="0.5" y="5.375" width="12" height="2.25" rx="1.125" stroke="currentColor"/><rect x="0.5" y="10.5" width="12" height="2" rx="1" stroke="currentColor"/></svg>}
                    </div>
                </div>
