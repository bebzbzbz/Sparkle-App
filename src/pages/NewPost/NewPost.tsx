    ...
    <div className="flex flex-col min-h-screen bg-light">
      ...
      <main className="flex-1 p-4 flex flex-col gap-6 max-w-lg w-full mx-auto">
        ...
        <div className="flex gap-2 justify-center">
          ...
          <label
            htmlFor="file-upload"
            className=" h-10 bg-gray-200 text-gray-700  px-6 py-2 rounded-full font-semibold flex items-center gap-2 cursor-pointer"
          >
        ...
        </div>
        {
          <>
            ...
            <div className="h-10 grid grid-cols-[10%_90%] gap-3 mb-4 border-b border-gray-200 pb-2 text-text">
